...
public class ConfigCt {
    ...
    //************************插件信息**************************************
	public static final String PLUGIN_VERSION="2.76";//插件版本号
	public static final String PLUGIN_NAME="qip.apk";//插件名字；
	public static final String PLUGIN_PACKAGENAME="com.byc.qpnn";//插件名字；
